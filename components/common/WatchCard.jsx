      ...
      <div className="bg-card rounded overflow-hidden shadow hover:shadow-xl transition-all duration-300 h-full flex flex-col group cursor-pointer">
        ...
        <div className="relative overflow-hidden bg-muted h-64">
          <Image
            ...
            loading="lazy"
          />
          <div className="absolute top-2 right-2 bg-secondary text-foreground px-3 py-1 rounded-full text-xs font-semibold">
        ...
        <div className="flex-1 p-4 flex flex-col">
          ...
          <div className="flex items-center gap-1 mb-4">
            <div className="flex gap-1">
              {[...Array(5)].map((_, i) => (
                <span key={i} className={i < Math.floor(watch.rating) ? 'text-secondary' : 'text-muted'}>
                  ★
                </span>
              ))}
            </div>
