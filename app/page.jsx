				...
				<div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
					<div className="flex flex-col justify-center">
						...
						<p className="text-lg text-muted-foreground mb-6 text-pretty">
							Explore our curated collection of premium watches from
							world-renowned brands. Each timepiece tells a story of precision,
							heritage, and sophisticated design.
						</p>
			...
			<section className="max-w-7xl mx-auto px-4 py-16 md:py-24">
				<div className="text-center mb-12">
					...
					<p className="text-muted-foreground max-w-2xl mx-auto">
						Browse our top-rated selection of luxury watches. From classic
						timepieces to modern innovations, find your perfect watch.
					</p>
				</div>
