    ...
    return (
      <Layout>
        <div className="max-w-7xl mx-auto px-4 py-8 text-center">
          <h1 className="text-2xl font-bold text-foreground mb-4">Watch not found</h1>
    ...
    <Layout>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span>/</span>
          <Link href="/watches" className="hover:text-foreground">Watches</Link>
          <span>/</span>
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="flex gap-1">
                  {[...Array(5)].map((_, i) => (
                    <span key={i} className={i < Math.floor(watch.rating) ? 'text-secondary text-2xl' : 'text-muted text-2xl'}>
                      ★
                    </span>
                  ))}
                </div>
        ...
        <div className="mb-16">
          <div className="flex gap-8 border-b border-border mb-8">
            {['overview', 'specs', 'reviews'].map(tab => (
              <button
                ...
                className={activeTab === tab ? 'pb-4 font-medium transition text-foreground border-b-2 border-secondary' : 'pb-4 font-medium transition text-muted-foreground hover:text-foreground'}
              >
          ...
          {activeTab === 'overview' && (
            <div className="space-y-4">
              ...
              <p className="text-foreground leading-relaxed">
                This exquisite timepiece represents the pinnacle of horological craftsmanship. Designed with meticulous attention to detail, every component has been engineered to provide exceptional accuracy and durability.
              </p>
            </div>
          )}
            ...
            <div className="space-y-6">
              <div className="bg-card rounded p-6 border border-border">
                ...
                <p className="text-foreground">
                  Absolutely stunning watch! The craftsmanship is impeccable, and it arrived in perfect condition.
                </p>
              </div>
              ...
              <div className="bg-card rounded p-6 border border-border">
                ...
                <p className="text-foreground">
                  Excellent watch. The only reason for 4 stars is the slight wait time for delivery.
                </p>
              </div>
            </div>
          )}
